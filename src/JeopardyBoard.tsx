...
const initialCategories: Category[] = [
  {
    ...
    questions: [
      ...
      {
        question:
          "This algorithm, commonly used in AI and game development, finds the shortest path from a start node to a target node using heuristics.",
  ...
  {
    name: "The Mysteries of the World",
    questions: [
      {
        question: "Placeholder question 1",
        answer: "Placeholder answer 1",
